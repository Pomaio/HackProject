(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var font = 20;
            var max = { r: 250, fontSize: font, iamgeUrl: 'assets/planets/jupitier.svg', challengeId: 1 };
            var medium = { r: 175, fontSize: font, iamgeUrl: 'assets/planets/mercury.svg', challengeId: 1 };
            var min = { r: 125, fontSize: font, iamgeUrl: 'assets/planets/jupitier.svg', challengeId: 1 };
            var MAP_DEFAULT = {
                nodes: [
                    {
                        name: 'Старт',
            ...
            var FakeBackendInterceptor = /** @class */ (function () {
                ...
                FakeBackendInterceptor.prototype.intercept = function (request, next) {
                    ...
                    function currentUser() {
                        ...
                        var id = parseInt(headers.get('Authorization').split('.')[1], 10);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var JwtInterceptor = /** @class */ (function () {
                ...
                JwtInterceptor.prototype.intercept = function (request, next) {
                    ...
                    var isApiUrl = request.url.startsWith(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RoleBasedDirective = /** @class */ (function () {
                function RoleBasedDirective(templateRef, viewContainer, workflowService) {
                    this.templateRef = templateRef;
                    this.viewContainer = viewContainer;
                    this.workflowService = workflowService;
                }
                RoleBasedDirective.prototype.ngOnInit = function () {
                    this.applyPermission();
                };
                RoleBasedDirective.prototype.applyPermission = function () {
                    var _this = this;
                ...
                RoleBasedDirective.prototype.ngOnDestroy = function () {
                    this.permission$.unsubscribe();
                };
                return RoleBasedDirective;
            }());
            RoleBasedDirective.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RoleBasedModule = /** @class */ (function () {
                function RoleBasedModule() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            ZoomableDirective.ctorParameters = function () { return [
                { type: _services_d3_service__WEBPACK_IMPORTED_MODULE_2__["D3Service"] },
                { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var EducationNode = /** @class */ (function () {
                function EducationNode(id, r, fontSize, imageUrl, name, result, challengeId) {
                    this.linkCount = 0;
                    this.id = id;
                    this.r = r;
            ...
            var EducationLink = /** @class */ (function () {
                function EducationLink(source, target) {
                    this.source = source;
                    this.target = target;
                }
                ...
                ForceDirectedGraph.prototype.initSimulation = function (options) {
                    ...
                    if (!this.simulation) {
                        ...
                        this.simulation = d3__WEBPACK_IMPORTED_MODULE_3__["forceSimulation"]()
                            .force('charge', d3__WEBPACK_IMPORTED_MODULE_3__["forceManyBody"]().strength(function (d) { return FORCES.CHARGE * d['r']; }))
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChallengeService = /** @class */ (function () {
                ...
                ChallengeService.prototype.getChallengeById = function (id) {
                    var res = this.challenges.filter(function (item) { return item.id === id; });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var D3Service = /** @class */ (function () {
                ...
                D3Service.prototype.applyZoomableBehaviour = function (svgElement, containerElement) {
                    ...
                    var initialTransform = d3__WEBPACK_IMPORTED_MODULE_3__["zoomIdentity"].translate(527, 187).scale(0.18);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TelegramBotService = /** @class */ (function () {
                function TelegramBotService(authService, http) {
                ...
                TelegramBotService.prototype.userStartChallenge = function (challenge) {
                    if (this.authService.currentUserValue.firstName) {
                        var message = "User " + this.authService.currentUserValue.firstName + "\n start challenge " + challenge.name;
                        this.http
            ...
            TelegramBotService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WorkflowService = /** @class */ (function () {
                function WorkflowService(authService) {
                    ...
                    this.userRoles$ = this.authService.currentUser$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (user) {
                        if (user) {
                ...
                WorkflowService.prototype.checkAuthorization = function (path) {
                    var _this = this;
                    return this.userRoles$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (roles) { return _this.doCheckAuthorization(path, roles); }));
                };
                WorkflowService.prototype.doCheckAuthorization = function (path, roles) {
                    if (path.length) {
                        var entry = this.findEntry(this.WORKFLOW_EVENTS, path);
                        if (entry && entry['permittedRoles'] && roles.size) {
                            return entry.permittedRoles.some(function (permittedRole) { return roles.has(permittedRole); });
                        }
                        return false;
                    }
                    return false;
                 ...
                 */
                WorkflowService.prototype.findEntry = function (currentObject, keys, index) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _components_map_skills_map_skills_module__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/map-skills/map-skills.module */ "./src/app/components/map-skills/map-skills.module.ts");
            ...
            AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
                    ...
                    imports: [
                        ...
                        _components_map_skills_map_skills_module__WEBPACK_IMPORTED_MODULE_12__["MapSkillsModule"],
                    ...
                    providers: [
                        ...
                        { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HTTP_INTERCEPTORS"], useClass: _helpers__WEBPACK_IMPORTED_MODULE_14__["JwtInterceptor"], multi: true },
                        { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HTTP_INTERCEPTORS"], useClass: _helpers__WEBPACK_IMPORTED_MODULE_14__["ErrorInterceptor"], multi: true },
                        // provider used to create fake backend
                        _helpers__WEBPACK_IMPORTED_MODULE_14__["fakeBackendProvider"]
                    ],
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CarouselComponent = /** @class */ (function () {
                ...
                CarouselComponent.prototype.ngAfterViewInit = function () {
                    var instances = materialize_css_dist_js_materialize_min__WEBPACK_IMPORTED_MODULE_2__["Carousel"].init(this.carousel.nativeElement, null);
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MapSkillsComponent = /** @class */ (function () {
                function MapSkillsComponent(d3Service, ref) {
                    this.d3Service = d3Service;
                    this.ref = ref;
                    this._options = { width: 800, height: 600 };
                }
                MapSkillsComponent.prototype.onResize = function (event) {
                    this.graph.initSimulation(this.options);
                };
                MapSkillsComponent.prototype.ngOnInit = function () {
                    /** Receiving an initialized simulated graph from our custom d3 service */
                    this.graph = this.d3Service.getForceDirectedGraph(this.nodes, this.links, this.options);
                };
                MapSkillsComponent.prototype.ngAfterViewInit = function () {
                    var _this = this;
                    this.graph.initSimulation(this.options);
                ...
                Object.defineProperty(MapSkillsComponent.prototype, "options", {
                    get: function () {
                ...
                return MapSkillsComponent;
            }());
            MapSkillsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _visuals_node_visual_node_visual_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./visuals/node-visual/node-visual.component */ "./src/app/components/map-skills/visuals/node-visual/node-visual.component.ts");
            /* harmony import */ var _visuals_link_visual_link_visual_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./visuals/link-visual/link-visual.component */ "./src/app/components/map-skills/visuals/link-visual/link-visual.component.ts");
            /* harmony import */ var src_app_services__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/_services */ "./src/app/_services/index.ts");
            var MapSkillsModule = /** @class */ (function () {
                function MapSkillsModule() {
                }
                return MapSkillsModule;
            }());
            MapSkillsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
                    declarations: [_map_skills_component__WEBPACK_IMPORTED_MODULE_5__["MapSkillsComponent"], src_app_helpers__WEBPACK_IMPORTED_MODULE_6__["DraggableDirective"], src_app_helpers__WEBPACK_IMPORTED_MODULE_6__["ZoomableDirective"], _visuals_node_visual_node_visual_component__WEBPACK_IMPORTED_MODULE_7__["NodeVisualComponent"], _visuals_link_visual_link_visual_component__WEBPACK_IMPORTED_MODULE_8__["LinkVisualComponent"]],
                    ...
                    providers: [src_app_services__WEBPACK_IMPORTED_MODULE_9__["D3Service"]]
                })
            ], MapSkillsModule);
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony default export */ __webpack_exports__["default"] = (".node {\n  cursor: pointer;\n  transition: stroke-width 0.1s ease-out, fill 0.1s ease-out, stroke 0.1s ease-out;\n}\n\n.node-name {\n  font-family: \"Lato\";\n  text-anchor: middle;\n  alignment-baseline: central;\n  font-weight: 300;\n  fill: white;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NodeVisualComponent = /** @class */ (function () {
                function NodeVisualComponent(router) {
                    this.router = router;
                }
                NodeVisualComponent.prototype.evaluateImageUrl = function () {
                    return "url('#pat" + this.node.id + "')";
                };
                NodeVisualComponent.prototype.onDoubleClick = function (event) {
                    event.stopPropagation();
                    this.router.navigate(['/test/' + this.node.chalengeId]);
                };
                return NodeVisualComponent;
            }());
            NodeVisualComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LandingComponent = /** @class */ (function () {
                ...
                LandingComponent.prototype.ngOnInit = function () {
                    ...
                    this.moveEvent$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["throttleTime"])(2), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.destroy$)).subscribe(function (e) {
                        _this.countX += e.movementX / 15;
                        _this.countY += e.movementY / 15;
                        document.getElementById('page__container').style.backgroundPositionX = _this.countX + "px";
                        document.getElementById('page__container').style.backgroundPositionY = _this.countY + "px";
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MapComponent = /** @class */ (function () {
                function MapComponent() {
                    this.nodes = [];
                    this.links = [];
                    var nodesTree = _data_map__WEBPACK_IMPORTED_MODULE_4__["MAP_DEFAULT"].nodes;
                    var linksTree = _data_map__WEBPACK_IMPORTED_MODULE_4__["MAP_DEFAULT"].links;
                    var N = src_app_app_config__WEBPACK_IMPORTED_MODULE_3__["default"].N;
                    ...
                    var _loop_1 = function (i) {
                        ...
                        var sourceID = nodesTree.reduce(function (res, el, index) {
                            if (el.name === linksTree[i].source) {
                                return index;
                            }
                            return res;
                        }, 0);
                        var targetID = nodesTree.reduce(function (res, el, index) {
                        ...
                        this_1.links.push(new src_app_models__WEBPACK_IMPORTED_MODULE_2__["EducationLink"](sourceID, targetID));
                    };
                    var this_1 = this;
                    for (var i = 0; i < linksTree.length; i++) {
                        _loop_1(i);
                    }
                }
                return MapComponent;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_components_map_skills_map_skills_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/components/map-skills/map-skills.module */ "./src/app/components/map-skills/map-skills.module.ts");
            /* harmony import */ var _landing_landing_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./landing/landing.component */ "./src/app/pages/map/landing/landing.component.ts");
            ...
            MapModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
                    declarations: [_map_component__WEBPACK_IMPORTED_MODULE_3__["MapComponent"], _landing_landing_component__WEBPACK_IMPORTED_MODULE_5__["LandingComponent"]],
                    imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], src_app_components_map_skills_map_skills_module__WEBPACK_IMPORTED_MODULE_4__["MapSkillsModule"]]
                })
            ], MapModule);
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var PageRoutingComponent = /** @class */ (function () {
                function PageRoutingComponent() {
                }
                PageRoutingComponent.prototype.ngOnInit = function () {
                };
                return PageRoutingComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Student_DATA = new Array(30).fill(null).map(function (v, i) { return ({
            ...
            var Teacher_DATA = new Array(30).fill(null).map(function (v, i) { return ({
                name: faker__WEBPACK_IMPORTED_MODULE_2__["name"].firstName(),
                position: i,
                score: faker__WEBPACK_IMPORTED_MODULE_2__["random"].number(),
                region: faker__WEBPACK_IMPORTED_MODULE_2__["address"].country()
            ...
            var RatingComponent = /** @class */ (function () {
                ...
                RatingComponent.prototype.fiiterData = function (page) {
                    this.dataSource = this.DATA.slice(10 * page, 10 * (page + 1));
                };
                RatingComponent.prototype.pageEvent = function (e) {
                    console.log(e);
                    this.fiiterData(e.pageIndex);
                };
                RatingComponent.prototype.changeData = function (value) {
                    this.DATA = value === 'students' ? Student_DATA : Teacher_DATA;
                    this.fiiterData(0);
                };
                RatingComponent.prototype.getStar = function (position) {
                    switch (position) {
                        case 0:
                            return '★'.repeat(3);
                        case 1:
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony default export */ __webpack_exports__["default"] = (":host {\n  display: block;\n  padding: 20px 0;\n}\n\n.section {\n  margin-bottom: 40px;\n}\n\n.section_about-you {\n  display: flex;\n  flex-wrap: wrap;\n  align-items: center;\n}\n\n.section-title {\n  padding-bottom: 20px;\n  font-size: 40px;\n  font-weight: bold;\n  display: flex;\n  width: 100%;\n}\n\n.section-title:before, .section-title:after {\n  content: \"\";\n  border-bottom: 2px solid #222329;\n  margin: auto 0;\n}\n\n.section-title:before {\n  width: 50px;\n  margin-right: 20px;\n}\n\n.section-title:after {\n  flex-grow: 1;\n  margin-left: 20px;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TestComponent = /** @class */ (function () {
                function TestComponent(router, _formBuilder, challengeService, route, telegramBot) {
                    this.router = router;
                ...
                TestComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.challenge$ = this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (params) { return _this.challengeService.getChallengeById(Number.parseInt(params.get('id'), 10)); }));
                    this.challenge$.subscribe(function (e) {
                        // this.telegramBot.userStartChallenge(e);
                        _this.testData = e;
                    });
                    var hobbiesGroup = {};
                    this.testData.excersices.forEach(function (hobby) {
                ...
                TestComponent.prototype.onSubmit = function () {
                    ...
                    // @ts-ignore
                    _data_map__WEBPACK_IMPORTED_MODULE_7__["MAP_DEFAULT"].nodes.reduce(function (res, el) {
                        if (el.challengeId === _this.testData.id) {
                            return el;
                        }
                        return res;
                    }, {}).result = this.testData.excersices.reduce(function (sum, el) {
                        if (el.rightAnswer === _this.contactForm.value.hobbies[el.title]) {
                            return sum += 10;
                        }
                        return sum;
                    }, 0);
